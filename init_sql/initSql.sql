...
CREATE TABLE `persistent_logins` (
  ...
  INSERT INTO `spring_boot`.`sys_role` (`id`, `name`) VALUES ('1', 'ADMIN');
  INSERT INTO `spring_boot`.`sys_role` (`id`, `name`) VALUES ('2', 'USER');
  INSERT INTO `spring_boot`.`sys_role` (`id`, `name`) VALUES ('3', 'VIP');
  INSERT INTO `spring_boot`.`sys_role` (`id`, `name`) VALUES ('4', 'SUPER');
...
INSERT INTO `spring_boot`.`sys_user_sys_roles` (`sys_user_id`, `sys_roles_id`) VALUES ('1', '2');
INSERT INTO `spring_boot`.`sys_user_sys_roles` (`sys_user_id`, `sys_roles_id`) VALUES ('2', '3');
INSERT INTO `spring_boot`.`sys_user_sys_roles` (`sys_user_id`, `sys_roles_id`) VALUES ('3', '1');
